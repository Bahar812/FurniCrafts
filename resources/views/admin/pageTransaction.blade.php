            ...
            <table class="table">
              ...
              <tbody>
               ...
               <tr>
                ...
                <td>{{ $transaction->statusPembayaran }}</td>
                <td>{{ $transaction->tipePembayaran }}</td>
                {{-- <td>{{ $user->status }}</td> --}}
                {{-- <td>{{ $user->created_at }}</td> --}}
                {{-- <td><a href="/edit/{{ $transaction->uuid }}" class="btn btn-info btn-sm">Edit</a></td>
                <td><a href="/delete/{{ $transaction->uuid }}" class="btn btn-danger btn-sm">Delete</a></td> --}}
               </tr>
               @endforeach
               @else
               <tr>
