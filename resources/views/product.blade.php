  ...
  <section class="mt-0 ">
    ...
    <div class="py-10 bg-img-cover bg-overlay-dark position-relative overflow-hidden bg-pos-center-center rounded-0"
        ...
        <div class="container-fluid position-relative z-index-20" data-aos="fade-right" data-aos-delay="300">
            <h1 class="fw-bold display-6 mb-4 text-white">Office Furniture</h1>
            <div class="col-12 col-md-6">
                <p class="text-white mb-0 fs-5">
                    Elevate your workspace with FurniCrafts' comprehensive office furniture collection. Discover ergonomic designs and stylish solutions crafted to enhance productivity and comfort in every office setting.
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="offcanvas-body">
                    <form method="GET" action="{{ route('home') }}">
                        <div class="mb-3">
                            <label for="priceRange" class="form-label">Price Range</label>
                            <input type="text" id="priceRange" readonly class="form-control-plaintext">
                            <input type="hidden" name="minPrice" id="minPrice" value="{{ request('minPrice') }}">
                            <input type="hidden" name="maxPrice" id="maxPrice" value="{{ request('maxPrice') }}">
                            <div id="priceSlider" class="slider mt-3"></div>
                        </div>
