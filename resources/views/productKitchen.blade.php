...
@section("body")
  ...
  <section class="mt-0 ">
    ...
    <div class="py-10 bg-img-cover bg-overlay-dark position-relative overflow-hidden bg-pos-center-center rounded-0"
        style="background-image: url(./assets/images/banners/BANNER-BESAR-03.jpg);">
        <div class="container-fluid position-relative z-index-20" data-aos="fade-right" data-aos-delay="300">
            <h1 class="fw-bold display-6 mb-4 text-white">Kitchen Furniture</h1>
            <div class="col-12 col-md-6">
                <p class="text-white mb-0 fs-5">
                    Elevate your kitchen with FurniCrafts' premium furniture and accessories collection. Discover functional and stylish solutions designed to enhance efficiency and aesthetics in every culinary space, making cooking a delightful experience.
                </p>
            </div>
        </div>
    </div>
        ...
        <!-- Category Toolbar-->
            <div class="d-flex justify-content-between items-center pt-5 pb-4 flex-column flex-lg-row">
                <div>
                    ...
                    <form method="GET" action="{{ route('productRuangDapur') }}">
                        @csrf
                        <div class="mb-3">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                ...
                <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                    ...
                    <div class="card-body px-0">
                        <a class="text-decoration-none link-cover" href="/productRuangDapur/{{ $product->ItemId }}">{{ $product->Nama_Product }}</a>
